...
const url = 'http://localhost:4000/x3gine'
...
export default function Login() {
    ...
    const onSubmit = () => {
        fetcher({username: 'vuongnv', password: 'Vuong0123'})
    }
    return (
        <>
                ...
                <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
                    ...
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <p className="mt-10 text-center text-sm text-gray-500">
                            Not a member?{' '}
                            <a href="#" className="font-semibold leading-6 text-gray-800 hover:text-gray-500" onClick={() => router.push('/register')}>
                                Register now
                            </a>
                        </p>
                    </div>
